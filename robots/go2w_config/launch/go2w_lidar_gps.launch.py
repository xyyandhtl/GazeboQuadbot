...
def generate_launch_description():
    ...
    default_model_path = os.path.join(descr_pkg_share, "urdf/go2w_description.urdf.xacro")
    default_world_path = os.path.join(config_pkg_share, "worlds/bigHHH.world")
